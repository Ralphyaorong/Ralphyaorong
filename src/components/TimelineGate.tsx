...
const timeline: TimelineItem[] = [
  ...
  { time: "2018 — 2021", title: "系统学习与管理视角", role: "行政管理专业学习", text: "与独立制作阶段并行。在影像实践之外补充管理、信息技术、统计与市场相关知识，为内容生产的组织方式建立更多理解。", relation: "并行阶段" },
...
export function TimelineGate() {
  ...
  const hero = <SubpageHero eyebrow="DEVELOPMENT TIMELINE" title="个人发展时间轴" description="从技术执行、影像创作到 AI 内容工作流搭建，一段持续靠近创意、执行与工具链协同的实践路径。" image="/assets/generated/page-hero-timeline.webp" alt="工作台上沿时间线排列的影像档案" />;
