...
export default function CasesPage() {
  return (
    <>
      <SubpageHero eyebrow="CASES" title="案例" description="从 AI 工作流，到内容项目和直播场景；以素材、流程和真实执行为基础呈现。" image="/assets/generated/page-hero-cases.webp" alt="Ralph Studio 梳理内容生产工作流" />
