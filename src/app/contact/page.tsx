...
export default function ContactPage() {
  ...
  return (
    <>
      <SubpageHero eyebrow="CONTACT" title="联系我" description="如需查看更多作品、沟通合作，或进一步了解 AI 工作流案例，可以通过邮箱或微信联系我。" image="/assets/generated/page-hero-contact.webp" alt="雨夜窗边的工作台与联系准备物品" />
